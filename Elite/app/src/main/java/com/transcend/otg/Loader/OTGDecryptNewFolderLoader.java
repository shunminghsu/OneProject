 ...
 */
public class OTGDecryptNewFolderLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = OTGDecryptNewFolderLoader.class.getSimpleName();
    private Context mContext;
    private String mPath;

    public OTGDecryptNewFolderLoader(Context context, String path) {
        super(context);
        mContext = context;
        mPath = path;
    }
