 ...
 */
public class LocalEncryptLoader extends AsyncTaskLoader<Boolean> {
    private static final String TAG = LocalEncryptLoader.class.getSimpleName();
    ...
    public LocalEncryptLoader(Context context, List<String> encryptList){
