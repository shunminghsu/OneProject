 ...
 */
public class LocalEncryptCopyLoader extends AsyncTaskLoader<Boolean> {
    private static final String TAG = LocalEncryptCopyLoader.class.getSimpleName();
    ...
    public LocalEncryptCopyLoader(Context context, List<String> srcs, String dest) {
        super(context);
