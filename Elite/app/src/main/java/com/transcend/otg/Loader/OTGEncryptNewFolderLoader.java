 ...
 */
public class OTGEncryptNewFolderLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = OTGEncryptNewFolderLoader.class.getSimpleName();
    private Context mContext;
    private String mPath;

    public OTGEncryptNewFolderLoader(Context context, String path) {
        super(context);
        mContext = context;
        mPath = path;
    }
