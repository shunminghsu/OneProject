 ...
 */
public class SDDecryptLoader extends AsyncTaskLoader<Boolean> {
    private static final String TAG = SDDecryptLoader.class.getSimpleName();
    ...
    public SDDecryptLoader(Context context, List<String> decryptList) {
        super(context);
