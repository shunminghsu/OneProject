 ...
 */
public class OTGCopytoLocalLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = OTGCopytoLocalLoader.class.getSimpleName();
    ...
    public OTGCopytoLocalLoader(Context context, ArrayList<DocumentFile> src, String des) {
        super(context);
