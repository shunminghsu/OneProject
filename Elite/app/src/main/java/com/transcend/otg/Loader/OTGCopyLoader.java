 ...
 */
public class OTGCopyLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = OTGCopyLoader.class.getSimpleName();
    ...
    public OTGCopyLoader(Context context, ArrayList<DocumentFile> src, ArrayList<DocumentFile> des, String path) {
        super(context);
