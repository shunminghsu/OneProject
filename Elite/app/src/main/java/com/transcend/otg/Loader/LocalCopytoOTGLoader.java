 ...
 */
public class LocalCopytoOTGLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = LocalCopytoOTGLoader.class.getSimpleName();
    ...
    public LocalCopytoOTGLoader(Context context, List<String> src, ArrayList<DocumentFile> des) {
        super(context);
