 ...
 */
public class SDDecryptNewFolderLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = SDDecryptNewFolderLoader.class.getSimpleName();
    private Context mContext;
    private String mPath;

    public SDDecryptNewFolderLoader(Context context, String path) {
        super(context);
        mContext = context;
        mPath = path;
    }
