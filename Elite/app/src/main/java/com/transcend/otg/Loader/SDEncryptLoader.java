 ...
 */
public class SDEncryptLoader extends AsyncTaskLoader<Boolean> {
    private static final String TAG = SDEncryptLoader.class.getSimpleName();
    ...
    public SDEncryptLoader(Context context, List<String> encryptList){
