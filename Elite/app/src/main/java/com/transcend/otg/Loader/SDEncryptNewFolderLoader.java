 ...
 */
public class SDEncryptNewFolderLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = SDEncryptNewFolderLoader.class.getSimpleName();
    private Context mContext;
    private String mPath;

    public SDEncryptNewFolderLoader(Context context, String path) {
        super(context);
        mContext = context;
        mPath = path;
    }
