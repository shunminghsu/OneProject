 ...
 */
public class OTGDecryptLoader extends AsyncTaskLoader<Boolean> {
    private static final String TAG = OTGDecryptLoader.class.getSimpleName();
    ...
    public OTGDecryptLoader(Context context, List<String> decryptList) {
        super(context);
