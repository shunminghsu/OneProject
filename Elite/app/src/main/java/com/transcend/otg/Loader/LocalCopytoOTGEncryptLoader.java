 ...
 */
public class LocalCopytoOTGEncryptLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = LocalCopytoOTGEncryptLoader.class.getSimpleName();
    ...
    public LocalCopytoOTGEncryptLoader(Context context, List<String> src, ArrayList<DocumentFile> des) {
        super(context);
