 ...
 */
public class OTGCopytoLocalDecryptLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = OTGCopytoLocalDecryptLoader.class.getSimpleName();
    ...
    public OTGCopytoLocalDecryptLoader(Context context, ArrayList<DocumentFile> src, String des) {
        super(context);
    ...
    private boolean Copy() throws IOException {
        updateResult(getContext().getResources().getString(R.string.decrypting));
