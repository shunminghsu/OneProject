 ...
 */
public class OTGCopytoLocalEncryptLoader extends AsyncTaskLoader<Boolean> {

    private static final String TAG = OTGCopytoLocalEncryptLoader.class.getSimpleName();
